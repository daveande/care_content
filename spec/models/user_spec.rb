...
describe User do
  ...
  it "should require a hospital_id" do
    no_hospital = User.new(@attr.merge(:hospital_id => ""))
    no_hospital.should_not be_valid
  end
  ...
  describe "profile attributes" do
    ...
    it "should have a hospital attribute" do
      @user.should respond_to(:hospital)
    end
  end
